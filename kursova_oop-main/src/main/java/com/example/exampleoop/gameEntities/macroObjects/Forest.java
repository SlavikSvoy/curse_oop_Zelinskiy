...
public class Forest {
    private final List<WalkingZombie> zombies = new ArrayList<>();
    private final Rectangle rectangle;
    private final double x;
    private final double y;

    public Forest(double x, double y) throws FileNotFoundException {
        ImageView imageView = new ImageView(new Image(Objects.requireNonNull(
                Main.class.getResource("images/forest.png")).toString(),
        ...
        Label nameOfMacroObject = new Label("Ліс");
        nameOfMacroObject.setLayoutX(x + 100);
        nameOfMacroObject.setLayoutY(y - 30);
        ...
        rectangle = new Rectangle(x, y - 45, 420, 450);
